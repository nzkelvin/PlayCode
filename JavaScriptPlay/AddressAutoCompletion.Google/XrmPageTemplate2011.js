...
if (pageData.xrmUtilityExists) {
    Xrm.Utility = {
        openEntityForm: function (name, id, parameters) {
            ...
            /// <para>The string representation of a unique identifier or the record to open in the form. If not set a form to create a new record will be opened.</para>
            /// </param>
            /// <param name="parameters" type="Object" mayBeNull="true" optional="true" >
            /// <para>A dictionary object providing any valid extra query string parameters to be passed to the form. Invalid query string parameters will cause an error.</para>
            /// </param>
            /// <returns type="Object">Returns a window object.</returns>
        },
...
function _context() {
    ...
    //Indicates CRM 2011 R8 or later.
    if (pageData.xrmUtilityExists) {
        cntxt.getClientUrl = function () {
            /// <summary>
        ...
        cntxt.getServerUrl = function () {
            /// <summary>
            /// Deprecated. Use getClientUrl. Returns the base server URL. When a user is working offline with the Microsoft Dynamics CRM for Microsoft Office Outlook client, the URL is to the local Microsoft Dynamics CRM Web services.
            /// </summary>
            /// <returns type="String" />
            return pageData.ServerUrl;
        };
...
function _memoAttribute(name, value, format, isDirty, requiredLevel, submitMode, userPrivilege, controls, maxLength) {
    ...
    this.setValue = function (newValue) {
        ...
        else { throw { message: "Invalid argument. Valid arguments are null or a String." } }
    };
...
function _optionSetControl(name, disabled, label, visible, parent, attribute) {
    ...
    this.removeOption = function (value) {
        ...
        else { throw { message: "Invalid argument. Number or null value expected" } }
    }
}
...
function _tab(tb, index) {
    ...
    this.setLabel = function (label) {
        ...
        else { throw { message: "Invalid argument. String type expected." } }
    };
    this.setVisible = function (isVisible) {
        /// <summary>
        ...
        else { throw { message: "Invalid argument. Boolean type expected." } }
    };
...
function _navItem(item) {
    ...
    this.setVisible = function (isVisible) {
        ...
        else { throw { message: "Invalid argument. Expected boolean value." }; }
    };
}
