...
namespace Crm.CrmCommon.Entities
{
	...
	public partial class Contact : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Crm.CrmCommon.Entities.ContactState> StateCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Crm.CrmCommon.Entities.ContactState)(System.Enum.ToObject(typeof(Crm.CrmCommon.Entities.ContactState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Crm.CrmCommon.Entities.Contact> Referencedcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntities<Crm.CrmCommon.Entities.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedcontact_customer_contacts");
				this.SetRelatedEntities<Crm.CrmCommon.Entities.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<Crm.CrmCommon.Entities.Contact> Referencedcontact_master_contact
		{
			get
			{
				return this.GetRelatedEntities<Crm.CrmCommon.Entities.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedcontact_master_contact");
				this.SetRelatedEntities<Crm.CrmCommon.Entities.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public Crm.CrmCommon.Entities.Contact Referencingcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntity<Crm.CrmCommon.Entities.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.OnPropertyChanging("Referencingcontact_customer_contacts");
				this.SetRelatedEntity<Crm.CrmCommon.Entities.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
		...
		public Crm.CrmCommon.Entities.Contact Referencingcontact_master_contact
		{
			get
			{
				return this.GetRelatedEntity<Crm.CrmCommon.Entities.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
		}
	}
	...
	public partial class DataContext : Microsoft.Xrm.Sdk.Client.OrganizationServiceContext
	{
		...
		/// <summary>
		/// Gets a binding to the set of all <see cref="Crm.CrmCommon.Entities.Contact"/> entities.
		/// </summary>
		public System.Linq.IQueryable<Crm.CrmCommon.Entities.Contact> ContactSet
		{
			get
			{
				return this.CreateQuery<Crm.CrmCommon.Entities.Contact>();
			}
		}
	}
}
